namespace TwistedFate.Extensions
{
    using System.Linq;
    ...
    public static class HeroExts
    {
        ...
        public static double GetAlliesDamageNearEnemy(this Obj_AI_Hero enemy, float percent = 0.8f, float range = 750)
        {
            var fullDmg = 0.0;
        ...
        public static double GetEnemiesDamageNearAlly(this Obj_AI_Hero ally, float percent = 0.8f, float range = 750)
        {
            var fullDmg = 0.0;
            var slots = new[] { SpellSlot.Q, SpellSlot.W, SpellSlot.E, SpellSlot.R };
        ...
        public static double GetTotalDamageFromLib(this Obj_AI_Hero attacker, Obj_AI_Base defender)
        {
            var slots = new[] { SpellSlot.Q, SpellSlot.W, SpellSlot.E, SpellSlot.R };
            var spellDmg =
